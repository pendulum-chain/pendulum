...
// 20
// --output
// ../runtime/amplitude/src/weights/replace.rs
// --template
...
impl<T: frame_system::Config> replace::WeightInfo for SubstrateWeight<T> {
	...
	fn withdraw_replace() -> Weight {
		...
		Weight::from_parts(19_000_000, 4115)
	...
	fn accept_replace() -> Weight {
		...
		Weight::from_parts(178_000_000, 9319)
	...
	fn execute_replace() -> Weight {
		...
		//  Measured:  `1968`
		//  Estimated: `71867`
		// Minimum execution time: 7_872_000_000 picoseconds.
		Weight::from_parts(7_916_000_000, 71867)
	...
	fn cancel_replace() -> Weight {
		...
		Weight::from_parts(114_000_000, 9122)
