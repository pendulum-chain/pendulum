...
impl<T: frame_system::Config> issue::WeightInfo for SubstrateWeight<T> {
	...
	fn request_issue() -> Weight {
		...
		Weight::from_parts(91_000_000, 11106)
	...
	fn execute_issue() -> Weight {
		...
		//  Measured:  `2498`
		//  Estimated: `71867`
		// Minimum execution time: 7_993_000_000 picoseconds.
		Weight::from_parts(8_184_000_000, 71867)
	...
	fn cancel_issue() -> Weight {
		...
		Weight::from_parts(33_000_000, 4768)
