...
// 20
// --output
// ../runtime/pendulum/src/weights/replace.rs
// --template
...
impl<T: frame_system::Config> replace::WeightInfo for SubstrateWeight<T> {
	...
	fn request_replace() -> Weight {
		...
		Weight::from_parts(60_000_000, 7734)
	...
	fn accept_replace() -> Weight {
		...
		Weight::from_parts(204_000_000, 9319)
	...
	fn execute_replace() -> Weight {
		...
		//  Measured:  `1968`
		//  Estimated: `71867`
		// Minimum execution time: 7_837_000_000 picoseconds.
		Weight::from_parts(8_125_000_000, 71867)
	...
	fn cancel_replace() -> Weight {
		...
		Weight::from_parts(120_000_000, 9122)
