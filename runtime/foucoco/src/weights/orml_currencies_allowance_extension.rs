...
impl<T: frame_system::Config> orml_currencies_allowance_extension::WeightInfo for SubstrateWeight<T> {
	...
	fn add_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_725_511, 6082)
			// Standard Error: 1_958
			.saturating_add(Weight::from_parts(1_025_843, 0).saturating_mul(n.into()))
	...
	fn remove_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_276_768, 0)
			// Standard Error: 1_148
			.saturating_add(Weight::from_parts(999_025, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
