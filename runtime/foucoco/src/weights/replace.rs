...
impl<T: frame_system::Config> replace::WeightInfo for SubstrateWeight<T> {
	...
	fn request_replace() -> Weight {
		...
		Weight::from_parts(73_000_000, 4859)
	...
	fn withdraw_replace() -> Weight {
		...
		Weight::from_parts(29_000_000, 4082)
	...
	fn accept_replace() -> Weight {
		...
		Weight::from_parts(251_000_000, 9626)
	...
	fn execute_replace() -> Weight {
		...
		//  Measured:  `1935`
		//  Estimated: `71867`
		// Minimum execution time: 8_210_000_000 picoseconds.
		Weight::from_parts(8_314_000_000, 71867)
			.saturating_add(T::DbWeight::get().reads(6_u64))
	...
	fn cancel_replace() -> Weight {
		...
		Weight::from_parts(155_000_000, 9092)
