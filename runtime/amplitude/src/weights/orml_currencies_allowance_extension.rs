...
impl<T: frame_system::Config> orml_currencies_allowance_extension::WeightInfo for SubstrateWeight<T> {
	...
	fn add_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(12_008_345, 6082)
			// Standard Error: 2_122
			.saturating_add(Weight::from_parts(1_012_948, 0).saturating_mul(n.into()))
	...
	fn remove_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_434_399, 0)
			// Standard Error: 1_272
			.saturating_add(Weight::from_parts(999_387, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
