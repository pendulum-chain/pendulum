...
impl sc_executor::NativeExecutionDispatch for TestnetRuntimeExecutor {
	type ExtendHostFunctions = frame_benchmarking::benchmarking::HostFunctions;
...
#[allow(clippy::type_complexity)]
pub fn amplitude_parachain_build_import_queue(
	client: Arc<
		TFullClient<
			Block,
			amplitude_runtime::RuntimeApi,
			NativeElseWasmExecutor<AmplitudeRuntimeExecutor>,
		>,
	>,
	config: &Configuration,
...
pub async fn start_amplitude_parachain_node(
	parachain_config: Configuration,
	polkadot_config: Configuration,
	collator_options: CollatorOptions,
	id: ParaId,
	...
	start_node_impl::<amplitude_runtime::RuntimeApi, AmplitudeRuntimeExecutor, _, _, _>(
		parachain_config,
		polkadot_config,
		collator_options,
		id,
		|_| Ok(RpcModule::new(())),
		amplitude_parachain_build_import_queue,
		|client,
		 prometheus_registry,
		 telemetry,
		 task_manager,
...
/// Build the import queue for the parachain runtime.
#[allow(clippy::type_complexity)]
pub fn development_parachain_build_import_queue(
	client: Arc<
		TFullClient<
			Block,
...
/// Start a parachain node.
pub async fn start_development_parachain_node(
	parachain_config: Configuration,
	polkadot_config: Configuration,
	collator_options: CollatorOptions,
	id: ParaId,
	...
	start_node_impl::<development_runtime::RuntimeApi, DevelopmentRuntimeExecutor, _, _, _>(
		...
		id,
		|_| Ok(RpcModule::new(())),
		development_parachain_build_import_queue,
		|client,
		 prometheus_registry,
		 telemetry,
		 task_manager,
...
/// Build the import queue for the parachain runtime.
#[allow(clippy::type_complexity)]
pub fn testnet_parachain_build_import_queue(
	client: Arc<
		TFullClient<
			Block,
...
/// Start a parachain node.
pub async fn start_testnet_parachain_node(
	parachain_config: Configuration,
	polkadot_config: Configuration,
	collator_options: CollatorOptions,
	id: ParaId,
	...
	start_node_impl::<testnet_runtime::RuntimeApi, DevelopmentRuntimeExecutor, _, _, _>(
		parachain_config,
		polkadot_config,
		collator_options,
		id,
