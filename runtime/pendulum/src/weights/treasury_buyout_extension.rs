...
impl<T: frame_system::Config> treasury_buyout_extension::default_weights::WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: DiaOracleModule CoinInfosMap (r:2 w:0)
	...
	fn buyout() -> Weight {
		...
		Weight::from_parts(128_000_000, 7278)
	...
	fn update_allowed_assets(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_344_926, 3527)
			// Standard Error: 7_848
			.saturating_add(Weight::from_parts(1_166_175, 0).saturating_mul(n.into()))
