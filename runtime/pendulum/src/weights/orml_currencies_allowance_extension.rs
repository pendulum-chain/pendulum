...
impl<T: frame_system::Config> orml_currencies_allowance_extension::WeightInfo for SubstrateWeight<T> {
	...
	fn add_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_867_336, 6082)
			// Standard Error: 1_229
			.saturating_add(Weight::from_parts(1_008_691, 0).saturating_mul(n.into()))
	...
	fn remove_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_717_978, 0)
			// Standard Error: 1_636
			.saturating_add(Weight::from_parts(1_010_514, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
