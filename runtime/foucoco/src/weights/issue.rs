...
// 20
// --output
// ../runtime/foucoco/src/weights/issue.rs
// --template
...
impl<T: frame_system::Config> issue::WeightInfo for SubstrateWeight<T> {
	...
	fn execute_issue() -> Weight {
		...
		//  Measured:  `2499`
		//  Estimated: `71867`
		// Minimum execution time: 7_899_000_000 picoseconds.
		Weight::from_parts(8_108_000_000, 71867)
	...
	fn cancel_issue() -> Weight {
		...
		Weight::from_parts(30_000_000, 4735)
