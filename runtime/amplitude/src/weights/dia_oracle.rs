...
impl<T: frame_system::Config> dia_oracle::WeightInfo for SubstrateWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(14_000_000, 3903)
	...
	fn authorize_account() -> Weight {
		...
		Weight::from_parts(10_000_000, 3752)
	...
	fn authorize_account_signed() -> Weight {
		...
		Weight::from_parts(11_000_000, 6264)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `DiaOracleModule::AuthorizedAccounts` (r:1 w:0)
	...
	fn deauthorize_account_signed() -> Weight {
		...
		//  Estimated: `6264`
		// Minimum execution time: 11_000_000 picoseconds.
		Weight::from_parts(12_000_000, 6264)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `DiaOracleModule::AuthorizedAccounts` (r:1 w:0)
	...
	fn set_updated_coin_infos() -> Weight {
		...
		//  Measured:  `324`
		//  Estimated: `3789`
		// Minimum execution time: 9_615_000_000 picoseconds.
		Weight::from_parts(9_689_000_000, 3789)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `DiaOracleModule::AuthorizedAccounts` (r:1 w:0)
	...
	fn set_batching_api() -> Weight {
		...
		//  Estimated: `3789`
		// Minimum execution time: 9_000_000 picoseconds.
		Weight::from_parts(10_000_000, 3789)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}