...
impl<T: frame_system::Config> orml_currencies_allowance_extension::default_weights::WeightInfo for SubstrateWeight<T> {
	...
	fn add_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_105_645, 6082)
			// Standard Error: 2_439
			.saturating_add(Weight::from_parts(1_339_480, 0).saturating_mul(n.into()))
	...
	fn remove_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_824_769, 0)
			// Standard Error: 3_481
			.saturating_add(Weight::from_parts(1_300_759, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn approve() -> Weight {
		...
		Weight::from_parts(19_000_000, 3649)
