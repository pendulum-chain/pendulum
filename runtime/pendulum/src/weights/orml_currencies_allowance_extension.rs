...
// 20
// --output
// ../runtime/pendulum/src/weights/orml_currencies_allowance_extension.rs
// --template
...
impl<T: frame_system::Config> orml_currencies_allowance_extension::WeightInfo for SubstrateWeight<T> {
	...
	fn add_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(12_076_531, 6082)
			// Standard Error: 1_265
			.saturating_add(Weight::from_parts(1_035_865, 0).saturating_mul(n.into()))
	...
	fn remove_allowed_currencies(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_996_170, 0)
			// Standard Error: 1_419
			.saturating_add(Weight::from_parts(1_016_605, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
