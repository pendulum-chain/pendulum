...
// 20
// --output
// ../runtime/amplitude/src/weights/issue.rs
// --template
...
impl<T: frame_system::Config> issue::WeightInfo for SubstrateWeight<T> {
	...
	fn request_issue() -> Weight {
		...
		Weight::from_parts(82_000_000, 11106)
	...
	fn execute_issue() -> Weight {
		...
		//  Measured:  `2498`
		//  Estimated: `71867`
		// Minimum execution time: 7_989_000_000 picoseconds.
		Weight::from_parts(8_051_000_000, 71867)
