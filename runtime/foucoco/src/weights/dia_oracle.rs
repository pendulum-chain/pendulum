...
// 20
// --output
// ../runtime/foucoco/src/weights/dia_oracle.rs
// --template
...
impl<T: frame_system::Config> dia_oracle::WeightInfo for SubstrateWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(14_000_000, 3937)
	...
	fn authorize_account() -> Weight {
		...
		Weight::from_parts(9_000_000, 3770)
	...
	fn deauthorize_account_signed() -> Weight {
		...
		//  Estimated: `6298`
		// Minimum execution time: 11_000_000 picoseconds.
		Weight::from_parts(11_000_000, 6298)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `DiaOracleModule::AuthorizedAccounts` (r:1 w:0)
	...
	fn set_updated_coin_infos() -> Weight {
		...
		//  Measured:  `358`
		//  Estimated: `3823`
		// Minimum execution time: 9_923_000_000 picoseconds.
		Weight::from_parts(9_973_000_000, 3823)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `DiaOracleModule::AuthorizedAccounts` (r:1 w:0)
	...
	fn set_batching_api() -> Weight {
		...
		Weight::from_parts(10_000_000, 3823)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}