...
// 20
// --output
// ../runtime/pendulum/src/weights/treasury_buyout_extension.rs
// --template
...
impl<T: frame_system::Config> treasury_buyout_extension::WeightInfo for SubstrateWeight<T> {
	...
	fn buyout() -> Weight {
		...
		Weight::from_parts(163_000_000, 7734)
	...
	fn update_allowed_assets(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_172_040, 3527)
			// Standard Error: 9_390
			.saturating_add(Weight::from_parts(1_085_425, 0).saturating_mul(n.into()))
