...
// 20
// --output
// ../runtime/pendulum/src/weights/redeem.rs
// --template
...
impl<T: frame_system::Config> redeem::WeightInfo for SubstrateWeight<T> {
	...
	fn execute_redeem() -> Weight {
		...
		//  Measured:  `1765`
		//  Estimated: `71867`
		// Minimum execution time: 7_887_000_000 picoseconds.
		Weight::from_parts(8_077_000_000, 71867)
	...
	fn cancel_redeem_reimburse() -> Weight {
		...
		Weight::from_parts(122_000_000, 7734)
	...
	fn cancel_redeem_retry() -> Weight {
		...
		Weight::from_parts(101_000_000, 7734)
	...
	fn self_redeem() -> Weight {
		...
		Weight::from_parts(71_000_000, 6096)
			.saturating_add(T::DbWeight::get().reads(8_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	...
	fn mint_tokens_for_reimbursed_redeem() -> Weight {
		...
		Weight::from_parts(61_000_000, 7734)
