...
// 20
// --output
// ../runtime/amplitude/src/weights/treasury_buyout_extension.rs
// --template
...
impl<T: frame_system::Config> treasury_buyout_extension::WeightInfo for SubstrateWeight<T> {
	...
	fn buyout() -> Weight {
		...
		Weight::from_parts(84_000_000, 7734)
	...
	fn update_allowed_assets(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_205_036, 3527)
			// Standard Error: 3_728
			.saturating_add(Weight::from_parts(983_130, 0).saturating_mul(n.into()))
