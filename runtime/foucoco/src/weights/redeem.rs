...
impl<T: frame_system::Config> redeem::WeightInfo for SubstrateWeight<T> {
	...
	fn request_redeem() -> Weight {
		...
		Weight::from_parts(97_000_000, 7914)
	...
	fn liquidation_redeem() -> Weight {
		...
		Weight::from_parts(111_000_000, 8865)
	...
	fn execute_redeem() -> Weight {
		...
		//  Measured:  `1698`
		//  Estimated: `71867`
		// Minimum execution time: 8_763_000_000 picoseconds.
		Weight::from_parts(8_800_000_000, 71867)
	...
	fn cancel_redeem_reimburse() -> Weight {
		...
		Weight::from_parts(156_000_000, 8808)
	...
	fn cancel_redeem_retry() -> Weight {
		...
		Weight::from_parts(135_000_000, 8596)
	...
	fn self_redeem() -> Weight {
		...
		Weight::from_parts(91_000_000, 6096)
			.saturating_add(T::DbWeight::get().reads(8_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	...
	fn mint_tokens_for_reimbursed_redeem() -> Weight {
		...
		Weight::from_parts(78_000_000, 7989)
