...
impl<T: frame_system::Config> replace::WeightInfo for SubstrateWeight<T> {
	...
	fn request_replace() -> Weight {
		...
		Weight::from_parts(74_000_000, 4996)
	...
	fn withdraw_replace() -> Weight {
		...
		Weight::from_parts(30_000_000, 4115)
	...
	fn accept_replace() -> Weight {
		...
		Weight::from_parts(251_000_000, 9215)
	...
	fn execute_replace() -> Weight {
		...
		//  Measured:  `1968`
		//  Estimated: `71867`
		// Minimum execution time: 8_202_000_000 picoseconds.
		Weight::from_parts(8_279_000_000, 71867)
			.saturating_add(T::DbWeight::get().reads(6_u64))
	...
	fn cancel_replace() -> Weight {
		...
		Weight::from_parts(145_000_000, 9018)
