...
//! DATE: 2024-09-16, STEPS: `50`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> redeem::WeightInfo for SubstrateWeight<T> {
	...
	fn liquidation_redeem() -> Weight {
		...
		Weight::from_parts(105_000_000, 8865)
	...
	fn execute_redeem() -> Weight {
		...
		//  Measured:  `1731`
		//  Estimated: `71867`
		// Minimum execution time: 8_235_000_000 picoseconds.
		Weight::from_parts(8_350_000_000, 71867)
	...
	fn cancel_redeem_retry() -> Weight {
		...
		Weight::from_parts(117_000_000, 7734)
	...
	fn self_redeem() -> Weight {
		...
		Weight::from_parts(86_000_000, 6096)
			.saturating_add(T::DbWeight::get().reads(8_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	...
	fn mint_tokens_for_reimbursed_redeem() -> Weight {
		...
		Weight::from_parts(70_000_000, 7734)
